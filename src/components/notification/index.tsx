const NotificationC = () => {
    return (
        <div className="bg-indigo-900 text-center py-4 px-6 lg:px-4">
            <div className="p-2 bg-indigo-800 items-center text-indigo-100 leading-none nd:rounded lg:rounded-full flex lg:inline-flex" role="alert">
